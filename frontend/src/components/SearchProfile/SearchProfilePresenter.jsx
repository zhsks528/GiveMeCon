...
const SearchProfilePresenter = ({ handleCloseProfile, userProfile }) => {
          ...
          <Profile>
            <ThumbnailContainer>
              {userProfile.profile_image ? (
                <ProfileImage src={userProfile.profile_image} alt="프로필" />
              ) : (
                <NotImage />
              )}
            </ThumbnailContainer>
            ...
            <div>팔로워 : {userProfile.followers_count}</div>
            <div>팔로잉 : {userProfile.following_count}</div>
          </Profile>

          <Production>
            <SubTitle>
              <span>Post</span>
              <Count>{production ? production.length : 0}</Count>
            </SubTitle>
            <ProductionContainer>
              {production ? (
                production.map(item => (
...
export default SearchProfilePresenter;
